	...
	*公司数据（个人数据， 公司组织架构数据， 公司群数据）
	...
	Cache.prototype.loadXMLDoc= function(url,cfunc)
	{
		jQuery.ajax({
			...
			url: url,
			dataType:"json",
			// data:{"username":"zhigeng@wangjubao.com", "password":"zhigeng."},
	...
	Cache.prototype.initData= function(){
		...
		// this.loadXMLDoc('/work/project.htm?m=myProjectList&source=nim',function(json)
		// {
		...
		// 	// 	alert("success.")
		// 	// }
		// 	this.setData(this.tribesKeyList, this.tribesList,  JSON.parse(json).projectList);
        //
		// });
	}
